...
/**
 * @author PC-20
 * 인증이나 회원 관리에서 사용할  Domain Layer
 * 
 * 
 * 직렬화 시키는거  implements Serializable 넣어주기
 */
public class MemberVO implements Serializable {
	...
	public String toString() {
		return "MemberVO [mem_id=" + mem_id + ", mem_bir=" + mem_bir + ", mem_zip=" + mem_zip + ", mem_add1=" + mem_add1
				+ ", mem_add2=" + mem_add2 + ", mem_hometel=" + mem_hometel + ", mem_comtel=" + mem_comtel + ", mem_hp="
				+ mem_hp + ", mem_mail=" + mem_mail + ", mem_job=" + mem_job + ", mem_like=" + mem_like
				+ ", mem_memorial=" + mem_memorial + ", mem_memorialday=" + mem_memorialday + ", mem_mileage="

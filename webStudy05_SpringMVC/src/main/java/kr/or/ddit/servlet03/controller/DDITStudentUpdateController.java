...
@Controller
@RequestMapping("/ddit/studentUpdate.do")
...
//	@RequestMapping(value="/ddit/studentUpdate.do")
	@GetMapping
	public String doGet(@Valid @RequestParam("code")String code,
...
//	@PostMapping(value="/ddit/studentUpdate.do")
	@PostMapping

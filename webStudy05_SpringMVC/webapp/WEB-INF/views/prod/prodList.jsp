...
<body>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/js/paiging.js?time=${System.currentTimeMillis()}"></script>
	<script type="text/javascript">
		// 옵션 선택시 
		...
		$("#updateBtn")
				.on(
						...
						function() {
							...
							location.href = "${pageContext.request.contextPath }/prod/"
									+ prod_id + "/form?currentPage=" + currentPage;
						});
		// 추가버튼 눌렀을때 
		$("#insertBtn")
				.on(

...
public class HandlerMapper implements IHandlerMapper {
	...
	private static Logger logger = LoggerFactory.getLogger(HandlerMapper.class);
	 ...
	 public HandlerMapper(String...basePackages) {
		...
		Map<Class<?>, Annotation> handlerClasses = ReflectionUtils.getClassesWithAnnotationAtBasePackages(annotationType, basePackages);
		...
		Map<Method, Annotation> methodMap = ReflectionUtils.getMethodsWithAnnotationAtClass(handlerClass, annotationType, 
